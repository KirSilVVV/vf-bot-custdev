    ...
    try {
        ...
        await ctx.replyWithVideo(
            { source: videoPath },
            {
                caption: 
                    `Привет, ${userName}! 👋\n\n` +
                    `🚀 Я помогаю ПРЕВРАТИТЬ твои идеи в РЕАЛЬНЫЕ продукты!\n\n` +
                    `✨ Как это работает:\n` +
                    `• Пройдёшь Customer Development интервью (7 вопросов)\n` +
                    `• Я помогу сформулировать ПРОДАЮЩУЮ фичу\n` +
                    `• Опубликую в @ai_requests — сообщество проголосует\n` +
                    `• ТОПовые идеи разрабатывает ИИ-команда БЕСПЛАТНО для тебя!\n\n` +
                    `💰 ТЫ ЗАРАБОТАЕШЬ: 25% от каждого клиента, кто заплатит за твою фичу!\n\n` +
                    `⚡ Хочешь УСКОРИТЬ разработку?\n` +
                    `→ 1 Star (≈2₽) = +10 голосов = попадание в ТОП!\n\n` +
                    `💡 Готов? Напиши свою идею:`,
                reply_markup: {
                    inline_keyboard: [
                        [
                            { text: '📢 Посмотреть все идеи в канале', url: 'https://t.me/ai_requests' }
                        ]
                    ]
                }
            }
